...
module OS = struct
              ...
              module Path = struct
                              ...
                              let currentArc = ".";;
                              let parentArc = "..";;
                              let rec validVolume _ =
                                raise ((General.Fail "TODO"));;
                              ...
                              let rec splitDirFile s =
                                raise ((General.Fail "TODO"));;
                              let rec joinDirFile p =
                                raise ((General.Fail "TODO"));;
                              let rec splitBaseExt s =
                                raise ((General.Fail "TODO"));;
                              let rec joinBaseExt p =
                                raise ((General.Fail "TODO"));;
                              ...
                              let rec mkCanonical s =
                                raise ((General.Fail "TODO"));;
                              let rec isCanonical s =
                                raise ((General.Fail "TODO"));;
                              let rec isAbsolute s =
                                raise ((General.Fail "TODO"));;
                              let rec isRelative s =
                                raise ((General.Fail "TODO"));;
                              let rec isRoot s =
                                raise ((General.Fail "TODO"));;
              ...
              module Process = struct
                                 ...
                                 let rec terminate ((st : status)) =
                                   (raise ((General.Fail "TODO")) : 'a);;
                                 let exit = terminate;;
                                 end;;
              end;;