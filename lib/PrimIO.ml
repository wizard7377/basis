        ...
        readVec =
          Some
            (fun n ->
              ...
              let result =
                Vector.Vector.tabulate
                  (n, fun i -> Vector.Vector.sub (v, !pos + i))
              in
              pos := !pos + n;
              result);
        readArr = None;
