...
module CharVectorSlice = struct
                           ...
                           and findi' (f, sl, i) = begin
                             ...
                             if f (i, sub (sl, i)) then
                             (Some (i, sub (sl, i))) else
                             findi' (f, sl, i + 1) end end;;
                           let rec app f sl =
                             appi (fun x -> f ((fun (_, r) -> r) x)) sl;;
                           let rec map f sl =
                             mapi (fun x -> f ((fun (_, r) -> r) x)) sl;;
